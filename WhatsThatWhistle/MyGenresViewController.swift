                ...
                if let subscriptions = subscriptions {
                    for subscription in subscriptions {
                        database.delete(withSubscriptionID: subscription.subscriptionID, completionHandler: { str, error in
                            if error != nil {
                                let ac = UIAlertController(title: "Saving genres failed", message: "There was an error while saving your genres: \(error!.localizedDescription)", preferredStyle: .alert)
